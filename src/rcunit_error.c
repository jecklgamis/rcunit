...
const char *g_error_msg_tbl[] = {
        ...
        /* RCU_E_ENGINIT      */, "Engine initialization failed"
        /* RCU_E_ENGINITDONE  */, "Engine already initialized "
        /* RCU_E_ENGNOINIT    */, "Engine not initialized"
        /* RCU_E_INVENG       */, "Invalid engine"
